...
namespace IOperateIt.UI
{
    internal class UUISupport
    {
        ...
        /// </summary>
        internal static SavedInputKey UUIKey => new SavedInputKey("KeyUUIToggle", "IOperateIt", ModSettings.KeyUUIToggle.Encode(), true);
                ...
                UUIButton = UUIAPI.Register(
                    ...
                    onToggle: (value) =>
                    {
                        if (value)
                        {
                            ...
                            // Position the main panel properly based on UUI button / panel position
